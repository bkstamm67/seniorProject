...
class SubBizView: UIViewController, CLLocationManagerDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //access reuse business list via API call
        if let data = NSData(contentsOfURL: NSURL(string: Config.url + "getSubBiz.php?id=" + id)!){
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("cell", forIndexPath: indexPath) as! SubBizViewCustCell
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        fwdSub = sub //orderedDict[indexPath.row]["sub"]!
        self.performSegueWithIdentifier("SubBizToDet", sender: self)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "SubBizToDet"{
            ...
            //forward data to Reuse Many Business Map
            let destinationNavigationController = segue.destinationViewController as! UINavigationController
            let targetController = destinationNavigationController.topViewController as! ReuseManyBizMapView
            targetController.sub = sub
            targetController.cat = cat
            targetController.biz = fwdBiz
